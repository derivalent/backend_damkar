            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <!-- <a class="nav-link" href="laporan-masuk.html">
                ...
                <div class="sb-sidenav-footer">
                    <div class="small" style="padding-bottom: 2%;">Logged out as:</div>
                    <div style="display: grid;place-items: center;">
                        <a class="btn btn-light btn-sm" href="login.html"
                            style="padding: 6px; padding-left: 15%; padding-right: 15%;color: blue;"> &nbsp;Logout</a>
                    </div>
                </div>
            </nav>
        </div>